...
This guide introduces the design of Guppy Algorithms and the patterns used to
...
Begin with the library structure to see where components live and how Python
builders complement Guppy functions. Then use the core concepts and feature
